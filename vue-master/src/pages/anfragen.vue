...
<template>
  <div class="max-w-xl mx-auto mt-10 p-6 bg-zinc-900 rounded-xl shadow-lg text-white">
    <h1 class="text-3xl font-bold text-purple-400 mb-6 text-center">📩 Anfrage senden</h1>
